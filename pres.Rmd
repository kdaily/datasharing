...
Categorical data: unordered, multiple categories
...
You should code missing values in a standardized way (preferably `NA`).
...
You should also add a new column to your data called `VariableNameCensored` which should have values of `TRUE` if censored and `FALSE` if not. 

Furthermore, explain these in the code book.
...
When in doubt, reach out to an analyst!
